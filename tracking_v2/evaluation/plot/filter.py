...
__all__ = ['plot_nscore', 'plot_error', 'plot_2d', 'plot_3d', 'plot_runs', 'plot_error_vs_nees', 'plot_track']
...
def plot_nscore(score: NScoreEvaluationResult, title: str = None, skip: int=0, skip_outlayers: float = None) -> go.Figure:
    ...
    h1.add_annotation(text=f"{lower*100:.2f}%", xref="x domain", yref="y domain", x=0, y=1, showarrow=False)
